...
3. Run sysprep before proceeding with script.
#>
...
$imageUri = "https://stg001.blob.core.windows.net/system/Microsoft.Compute/Images/vm001-osDisk.vhd"
$osDiskUri = "https://stg001.blob.core.windows.net/vhds/vm001-osDisk.vhd"
$vm = Set-AzureRmVMOSDisk -VM $vm -Name $osDiskName -VhdUri $osDiskUri -CreateOption fromImage -SourceImageUri $imageUri -Windows

## Adiciona o disco de Dados
$dataImageUri = "https://stg001.blob.core.windows.net/system/Microsoft.Compute/Images/vm001-dataDisk.vhd"
$dataDiskUri = "https://stg001.blob.core.windows.net/vhds/vm001-dataDisk.vhd"
$vm = Add-AzureRmVMDataDisk -VM $vm -Name "dataDisk1" -VhdUri $dataDiskUri -SourceImageUri $dataImageUri -Lun 0 -CreateOption fromImage
